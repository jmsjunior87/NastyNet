    ...
    try {
        const cohereResponse = await fetch('https://api.cohere.ai/v1/generate', {  // Usando a URL de versão mais recente
            ...
            body: JSON.stringify({
                ...
                prompt: `Você é uma mulher bem mal humorada, que responde de forma muito informal, grosseira e com gírias, com até 50 palavras, Use palavrões quando necessário, sem ser educada ou gentil. Use o mínimo de pontuação possível, a não ser que seja uma pergunta. Responda de forma curta e direta à seguinte pergunta de forma concisa: ${message.content}`,
                max_tokens: 150,
            }),
        });
